...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            System.out.println("7.epicks user storys en zo");
            ...
            switch (keuze) {
                ...
                case "7": 
                    while (true) {
                        ...
                        System.out.println("4. Alles tonen");
    ...
    private static void userStoryAanmaken(Scanner scanner) {
        ...
        userStories.add(new UserStory(naam, beschrijving));
    ...
    private static void epicAanmaken(Scanner scanner) {
        ...
        if (userStories.isEmpty()) {
            ...
            for (int i = 0; i < userStories.size(); i++) {
                System.out.println(i + ": " + userStories.get(i));
            }
...
class UserStory {
    ...
    public String toString() {
        return "UserStory: " + naam + " - " + beschrijving;
    }
}
...
class Epic {
    ...
    @Override
    public String toString() {
        StringBuilder sb = new StringBuilder("Epic: " + titel + "\n");
        sb.append("User Stories:\n");
        for (UserStory story : userStories) {
            sb.append(" - ").append(story).append("\n");
        }
        sb.append("Taken:\n");
        for (Task taak : taken) {
            sb.append(" - ").append(taak).append("\n");
        }
        return sb.toString();
    }
}